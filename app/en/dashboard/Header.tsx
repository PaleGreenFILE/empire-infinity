        ...
        <div className="flex justify-between md:mx-32 mx-5 ">
          <Link href="/">
            <div className=" flex space-x-3 items-center">
              ...
              <h1 className=" font-normal text-xl leading-6 text-white">
                Empire Infinity
              </h1>
            </div>
          </Link>
          ...
          <div
            ...
            className={`focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white justify-center items-center sm:hidden cursor-pointer transform duration-700 `}
          >
            <svg
